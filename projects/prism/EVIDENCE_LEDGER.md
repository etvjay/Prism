...
| EVD-PRISM-004 | Prism ID can be created/read on Starknet | X5 | X3 | PASS | SN_SEPOLIA `create_identity` tx `0x0457a43d908da21e8acd723ba94639d6009c123ec4c4d944175f2bbfa05e3a6f` succeeded at block `13960873`; `PrismIdentityCreated` event allocated Prism ID `0x1` to controller `0x047c0f8b01b9c7c75c669dc549bc305a0f2d796808117339a1c87730162b131c`; `get_identity(0x1)` matched via `sncast` and raw `starknet_call` on `starknet-sepolia-rpc.publicnode.com` | event/indexer reconciliation and full M1 vertical slice remain open |
